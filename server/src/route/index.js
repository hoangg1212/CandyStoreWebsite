...
function route(app) {
    ...
    app.get('/api/getContact', UserRoute);
    ...
    app.post('/api/deleteorder', AdminRoutes);
    app.get('/api/allcontact', AdminRoutes);
    app.post('/api/feedbackadmin', AdminRoutes);
    app.get('/api/datatest', AdminRoutes);
